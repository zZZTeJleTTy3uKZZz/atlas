...
Дмитрий — стратег; Claude — PM, который двигает бэклог. Atlas — инструмент этого PM.
...
2. **`--json` уже дефолт** — выход машиночитаем сам по себе. Для разговора с Дмитрием добавляй
...
Когда Дмитрий показывает папку проекта («добавь это в atlas», «изучи репо и заведи») или ты видишь
