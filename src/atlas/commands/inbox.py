...
from atlas.paths import INBOX_FOLDER_NAME, get_projects_root
...
inbox_app = typer.Typer(
    ...
    help="Inbox ПРОЕКТНОГО уровня (entity_kind=inbox, сырьё для AI-разбора). Лёгкий интейк — `atlas backlog`.",
)
console = Console()
