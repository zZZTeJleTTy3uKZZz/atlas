...
def test_pm_module_imports():
    """Слой БД должен импортироваться без ошибок."""
    from atlas import db, models
...
def test_project_requires_type_and_status():
    ...
    from atlas.db import make_engine, make_session
    from atlas.models import Base, Project, ProjectStatus, ProjectType
...
def test_action_log_is_append_only_in_contract():
    ...
    from atlas.db import make_engine, make_session
    from atlas.models import ActionLog, Base
