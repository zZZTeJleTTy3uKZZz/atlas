...
class TestIsWindows:
    def test_is_windows_returns_bool(self):
        from atlas.junctions import is_windows
...
class TestCreateJunctionMocked:
    ...
    def test_create_junction_raises_if_link_parent_missing(self, tmp_path):
        from atlas.junctions import create_junction
...
class TestRemoveJunctionSafety:
    def test_remove_junction_refuses_real_directory(self, tmp_path):
        ...
        from atlas.junctions import SafetyError, remove_junction
    ...
    def test_remove_junction_refuses_missing_path(self, tmp_path):
        from atlas.junctions import remove_junction
...
class TestIsJunctionCommon:
    def test_is_junction_returns_false_for_regular_directory(self, tmp_path):
        from atlas.junctions import is_junction
        (tmp_path / "real").mkdir()
...
class TestJunctionsIntegration:
    def test_create_and_detect_junction(self, tmp_path):
        from atlas.junctions import create_junction, is_junction
    ...
    def test_junction_target_returns_target(self, tmp_path):
        from atlas.junctions import create_junction, junction_target
...
class TestJunctionsCurrentOS:
    ...
    def test_create_junction_raises_if_link_exists_real_create(self, tmp_path):
        ...
        from atlas.junctions import JunctionError, create_junction
