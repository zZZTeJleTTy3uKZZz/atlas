...
def test_seed_project_types_creates_all_canon_types():
    ...
    from atlas.models import Base, ProjectType
...
def test_seed_all_is_idempotent():
    ...
    from atlas.db import make_engine, make_session
    from atlas.models import Base, Participant, ProjectStatus, ProjectType
...
def test_seed_participants_includes_owner_and_claude():
    from atlas.db import make_engine, make_session
    from atlas.models import Base, Participant
    from atlas.seeds import seed_all
    ...
    with make_session(engine) as session:
        ...
        assert owner.role_default == "Orchestrator"
