...
class TestTagCreation:
    def test_tag_create_minimal(self, fresh_db):
        ...
        tag = Tag(slug="owner", name="Owner", category="owner")
        fresh_db.add(tag)
        fresh_db.commit()
    ...
    def test_tag_slug_unique(self, fresh_db):
        ...
        t1 = Tag(slug="owner", name="Dmitry One", category="owner")
        fresh_db.add(t1)
        fresh_db.commit()

        t2 = Tag(slug="owner", name="Dmitry Two", category="owner")
        fresh_db.add(t2)
    ...
    def test_tag_valid_categories(self, fresh_db):
        ...
        from atlas.models import Tag as T
...
class TestProjectTagCascade:
    def test_m2m_basic_attach(self, fresh_db, seed_refs):
        ...
        tag = Tag(slug="owner", name="Dmitry", category="owner")
        fresh_db.add(tag)
        fresh_db.commit()
